...
- housing_density
- minim number of tress and other vegetation (`*_atleast`)
- `yard_`
...
species_code_data <- readr::read_csv('data/PFW-species-translation-table.csv')
...
## Point overlapping
data |> 
  count(loc_id, species_code, latitude) |> 
